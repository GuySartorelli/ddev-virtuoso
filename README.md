...
* The fundamental contents of the add-on service or other component. For example, in this template there is a [docker-compose.virtuoso.yaml](docker-compose.virtuoso.yaml) file.
